            ...
            <form onSubmit={handleSubmit}>
              <Tabs value={customerType} onValueChange={(v) => setCustomerType(v as "b2c" | "b2b")}>
                ...
                <TabsContent value="b2c" className="space-y-4">
                  <FieldGroup className="grid grid-cols-2 gap-4">
                    <Field>
                      ...
                      <Input
                        list="b2c-customer-names"
                        value={formData.customerName}
                        onChange={(e) => setFormData({ ...formData, customerName: e.target.value })}
                        onBlur={(e) => handleB2CCustomerLookup({ name: e.target.value })}
                    ...
                    <Field>
                      ...
                      <PhoneInput
                        list="b2c-customer-phones"
                        value={formData.customerPhone}
                        onChange={(value) => setFormData({ ...formData, customerPhone: value })}
                        onBlur={(e) => handleB2CCustomerLookup({ phone: e.target.value })}
                  ...
                  <FieldGroup className="grid grid-cols-2 gap-4">
                    <Field>
                      ...
                      <Input
                        list="b2c-customer-emails"
                        type="email"
                        value={formData.customerEmail || ""}
                        onChange={(e) => setFormData({ ...formData, customerEmail: e.target.value })}
                        onBlur={(e) => handleB2CCustomerLookup({ email: e.target.value })}
                  ...
                  {formData.b2cCustomerId && (
                    <Badge variant="secondary">
                      Customer ID: {b2cCustomers.find((customer) => customer.id === formData.b2cCustomerId)?.customerCode}
                    </Badge>
                  )}
                  <datalist id="b2c-customer-names">
                    {b2cCustomers.map((customer) => (
                      <option key={customer.id} value={customer.name} />
                    ))}
                  </datalist>
                  <datalist id="b2c-customer-phones">
                    {b2cCustomers.map((customer) => (
                      <option key={customer.id} value={customer.phone} />
                    ))}
                  </datalist>
                  <datalist id="b2c-customer-emails">
                    {b2cCustomers.filter((customer) => customer.email).map((customer) => (
                ...
                <TabsContent value="b2b" className="space-y-4">
                  ...
                  {formData.b2bClientId && (
                    <Field>
                      <FieldLabel>Select Employee (Booking For) *</FieldLabel>
                      <Select
